...
import userinterface.AnalystRole.AnalysisHomePageJpanel;
...
public class AnalystRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        return new AnalysisHomePageJpanel(userProcessContainer, account, (AnalystOrganization)organization, enterprise, business);
    }
