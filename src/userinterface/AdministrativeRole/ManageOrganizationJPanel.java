...
import static Business.Enterprise.Enterprise.EnterpriseType.Analysis;
...
import static Business.Enterprise.Enterprise.EnterpriseType.Police;
...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            if (!type.getValue().equals(Type.Admin.getValue()) && !type.getValue().equals(Type.HelpDesk.getValue()) && !type.getValue().equals(Type.Analyst.getValue()) && !type.getValue().equals(Type.Distributer.getValue())){
                organizationJComboBox.addItem(type);
            }
        }
        }
        else if(enterprise.getEnterpriseType().equals(Analysis)){
            for(Type type : Organization.Type.values()){
            ...
            for(Type type : Organization.Type.values()){
                if (type.getValue().equals(Type.Distributer.getValue())){
                organizationJComboBox.addItem(type);
            }
        }
        }
        else if(enterprise.getEnterpriseType().equals(Police)){
            for(Type type : Organization.Type.values()){
