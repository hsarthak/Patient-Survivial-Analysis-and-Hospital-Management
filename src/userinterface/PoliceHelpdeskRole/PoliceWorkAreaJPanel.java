...
public class PoliceWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private PoliceHelpDeskOrganization policeOrganization;
    
    /**
     * Creates new form PoliceWorkAreaJPanel
     */
    public PoliceWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization,Enterprise enterprise, EcoSystem business) {
        initComponents();
        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.policeOrganization = (PoliceHelpDeskOrganization)organization;
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : policeOrganization.getWorkQueue().getWorkRequestList()){
            ...
            //String incident = ((PoliceWorkRequest) request);
            row[0] = ((PoliceWorkRequest) request);
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Incident", "Sender", "Receiver", "Status"
            }
        ) {
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        PoliceWorkRequest request = (PoliceWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
     
        request.setStatus("Processing");
        
        PoliceProcessWorkRequestJPanel processWorkRequestJPanel = new PoliceProcessWorkRequestJPanel(userProcessContainer, request);
