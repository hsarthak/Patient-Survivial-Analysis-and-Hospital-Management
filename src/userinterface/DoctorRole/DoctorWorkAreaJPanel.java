...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, DoctorOrganization organization, Enterprise enterprise,Patients patient) {
        initComponents();
        ...
        valueLabel.setText(patient.getName());
    ...
    private void initComponents() {
        ...
        enterpriseLabel.setText("Patient Name:");
    ...
    private void backjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backjButton1ActionPerformed
        ...
        DoctorPatientDetails dwjp = (DoctorPatientDetails) component;
        dwjp.populatePatientsTable(userAccount);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
